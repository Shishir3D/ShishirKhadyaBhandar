...
<body>
  ...
  <section class="hero">
    <div class="container">
      ...
      <a href="#categories" class="cta-button">Shop Our Products</a>
    </div>
  </section>

  <section id="categories" class="featured-categories container">
    <h3>Our Fresh Selection</h3>
    <div class="category-grid">
      <div class="category-card">
        <img src="https://via.placeholder.com/100.png?text=Fruits" alt="Fruits & Vegetables">
        <h4>Fruits & Vegetables</h4>
        <p>Farm-fresh and full of flavor.</p>
        <a href="#" class="cta-button" style="font-size:0.9em; padding: 8px 15px;">View All</a>
      </div>
      <div class="category-card">
        <img src="https://via.placeholder.com/100.png?text=Dairy" alt="Dairy & Eggs">
        <h4>Dairy & Eggs</h4>
        <p>Fresh milk, cheese, yogurt, and eggs.</p>
        <a href="#" class="cta-button" style="font-size:0.9em; padding: 8px 15px;">View All</a>
      </div>
      <div class="category-card">
        <img src="https://via.placeholder.com/100.png?text=Bakery" alt="Bakery">
        <h4>Bakery & Breads</h4>
        <p>Deliciously baked goods, fresh daily.</p>
        <a href="#" class="cta-button" style="font-size:0.9em; padding: 8px 15px;">View All</a>
      </div>
      <div class="category-card">
        <img src="https://via.placeholder.com/100.png?text=Pantry" alt="Pantry Staples">
